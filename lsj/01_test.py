        ...
        for dir_name in dir_names:
            ...
            for section_name in section_names:
                ...
                for file_idx, file_path in tqdm(enumerate(files), total=len(files)):
                    try:
                        data = com.file_to_vectors(file_path, n_mels=param["feature"]["n_mels"], n_frames=param["feature"]["n_frames"], n_fft=param["feature"]["n_fft"], hop_length=param["feature"]["hop_length"], power=param["feature"]["power"])
                    except:
                    ...
                    data = tf.reshape(data, (data.shape[0], param["feature"]["n_frames"], param["feature"]["n_mels"], 1))
